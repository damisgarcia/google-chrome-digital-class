...
var common = (function() {
  ...
  function createNaClModule(name, tool, path, width, height, attrs) {
      navigator.webkitPersistentStorage.requestQuota(1024 * 1024 * 1024, //1GB
     function(bytes) {console.log('Allocated ' + bytes + ' bytes of persistant storage.'); },
     function(e) { console.log('Failed to allocate space') });
